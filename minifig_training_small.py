...
class MinifigDataset(Dataset):
    def __init__(self, annotations_file, img_dir, transform=v2.Compose([v2.Grayscale(), v2.CenterCrop(32)]), target_transform=None):
...
optimizer = torch.optim.SGD(model.parameters(), lr=1) #1e-3
